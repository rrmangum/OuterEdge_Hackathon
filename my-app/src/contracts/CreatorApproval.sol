...
contract CreatorApproval is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Creator Approval", "CA") {}

    ///// FUNCTION IMPORTS FROM OPENZEPPELIN CONTRACTS WIZARD ///

    // anyone can call issueNFT function
    function issueNFT(address to, string memory uri) external {
    ...
    // This function mints credentials and is called by issueNFT
